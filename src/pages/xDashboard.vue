   ...
   <header class="bg-white shadow">
    <!-- <div class="container mx-auto px-4 py-4 flex justify-between items-center">
     <div class="flex items-center">
      <img alt="Logo da Igreja" class="mr-4" height="50" src="../assets/logo_com_letra.webp" width="150"/>
      <nav class="hidden md:flex space-x-4">
       <a class="text-gray-600 hover:text-gray-800" href="/profile">
        Igreja
       </a>
   ...
   <footer class="bg-blue-900 text-white py-8">
    <div class="container mx-auto px-4">
     <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
      <div class="flex items-center">
       <img alt="Logo da Igreja" class="mr-4" height="100" src="../assets/logo.jpg" width="100"/>
       <div>
        <h3 class="text-lg font-bold">
         MENUS
        </h3>
